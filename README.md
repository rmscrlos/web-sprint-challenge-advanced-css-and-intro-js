...
1. How would you describe acessibility on the web to someone new to programming?
  ...
  -Website acessibility helps those who have a hard time or disbility to read your website.

2. Talk about 3 different things you can do to ensure your website is accessible. 

  - You can use semantic HTML, contrast color and spacings.

3. How would you explain the concept of a variable to someone new to programming?

  - A variable is a container of data. They contain primitive data types like strings, numbers, booleans, arrays and objects.

4. What is the purpose of using functions in code?
    
    - The purpose of a function is to allow you to run a block of code over and over as the function is called.
